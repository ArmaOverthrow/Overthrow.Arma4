...
**Epic:** core
**Status:** 🟢 3/6 documented (legacy); **player-groups ✅ COMPLETE (MP play-test green)**; persistence BUILT — SP green, MP/dedicated half outstanding; controller-migration 📋 planned & scoped
**Last Updated:** 2026-08-06 (player-groups closed)
...
- **Rollup status:** 🟢 3/6 documented; **player-groups ✅ complete (31/31, MP play-test green)**; persistence built (43/44, SP play-test green, MP half outstanding); controller-migration planned & scoped
