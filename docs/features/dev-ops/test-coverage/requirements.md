...
- `docs/features/vanilla-persistence/` — record that behaviour-level persistence tests now exist and act as the migration's acceptance gate
...
- Independent of `vanilla-persistence`'s progress; deliberately written to outlive it.
