...
**Status:** 🟡 In Progress (2/4 **closed**, 1 **built**) — `ui` and `storage` play-tested green and closed 2026-08-21; **`resources` built 2026-08-21 (11 phases + cross-phase review, Ready for Review — play-test owed)**; `building-repair` still at requirements and now **unblocked**
